...
const FAMILY_BROWSE = [
  ...
  },
  {
    ...
    props: {
      ...
      ages: [0.5],
      careType: "part-time care",
      schedule: { monday: true, tuesday: false, wednesday: true, thursday: false, friday: true, saturday: false, sunday: false },
  ...
  },
  {
    ...
    props: {
      ...
      careType: "full-time care",
      schedule: { monday: true, tuesday: true, wednesday: true, thursday: true, friday: true, saturday: false, sunday: false },
      location: { city: "Temescal" },
      sharedRate: "~$21/hr per family",
      soloRate: "$42/hr",
...
const NANNY_BROWSE = [
  ...
  },
  {
    ...
    props: {
      ...
      ages: [2],
      careType: "part-time care",
      schedule: { monday: true, tuesday: true, wednesday: false, thursday: true, friday: false, saturday: false, sunday: false },
      location: { city: "Piedmont" },
      sharedRate: "~$18/hr per family",
      soloRate: "$36/hr",
      hosting: "rotating between homes",
...
export default function HowItWorksBrowsePreview({ audience = "family" }) {
  ...
  return (
    <div className="overflow-hidden bg-[#F8FAFF] pointer-events-none h-[330px] sm:h-[400px]">
      <div className="w-[920px] origin-top-left scale-[0.39] sm:scale-[0.55] p-3 flex flex-col gap-2">
        {list.map((m, i) => (
          <MatchCard
            key={m.props.id}
