...
export default function MatchesEmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-6 py-16">
      <div className="w-12 h-12 rounded-2xl bg-[#AEC4FF] flex items-center justify-center mb-4">
        <Icon size={22} color="#001243" strokeWidth={1.8} />
      </div>
      ...
      {ctaLabel && onCta && (
        <button
          type="button"
          onClick={onCta}
          className="mt-6 bg-[#AEC4FF] hover:bg-[#9db4f7] text-[#001243] Livvic-Bold text-sm px-5 py-2.5 rounded-full transition-colors"
        >
          {ctaLabel}
        </button>
      )}
