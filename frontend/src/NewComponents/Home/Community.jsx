...
const communityResource = [
  {
    ...
    content: (
      <div className="space-y-8 text-[#444] text-[15px] sm:text-[16px] leading-relaxed Livvic">
        ...
        <div className="text-center bg-[#FFF3EA] p-6 sm:p-8 rounded-2xl border border-[#FFE4CC] mt-10">
          <h4 className="text-[#C4621A] Livvic-Bold text-xl sm:text-2xl mb-3">Looking for a nanny share family?</h4>
          <p className="text-[#C4621A] Livvic-Medium">FamLink helps families connect with nearby parents who have similar schedules, childcare needs, and preferences, making it easier to find a compatible nanny share.</p>
        </div>
      </div>
    )
  },
  ...
  },
  {
    ...
    content: (
      <div className="space-y-8 text-[#444] text-[15px] sm:text-[16px] leading-relaxed Livvic">
        ...
        <div className="text-center bg-[#FFF3EA] p-6 sm:p-8 rounded-2xl border border-[#FFE4CC] mt-10">
          <h4 className="text-[#C4621A] Livvic-Bold text-xl sm:text-2xl mb-3">Ready to explore nanny shares?</h4>
          <p className="text-[#C4621A] Livvic-Medium">Create your free FamLink profile to connect with nearby families looking to share a nanny, or use the Nanny Share Savings Calculator to see how much you could save.</p>
        </div>
      </div>
    )
  },
