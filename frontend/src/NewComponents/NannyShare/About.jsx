...
function About() {
  return (
    <div className="w-full bg-[#F6F3EE] relative pt-4 sm:pt-8 lg:pt-4 mt-4 sm:mt-4 lg:mt-1">
      ...
      <div className="container Livvic px-4 sm:px-6 lg:px-8 min-h-[450px] py-12">
