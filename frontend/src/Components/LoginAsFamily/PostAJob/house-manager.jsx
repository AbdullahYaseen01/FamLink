...
export const HouseManagerJob = () => {
  ...
  const step4Data = [{ name: "For child" }, { name: "For family" }];
  ...
  const step6Data = [{ name: "Yes" }, { name: "No" }];
      ...
      case 2:
        return (
          <HireStep4
            checkBox={true}
            formRef={jobFormRef || {}}
            head={"What specific duties do you need help with?"}
            data={step1Data}
            inputNot={true}
          />
        );
      ...
      case 3:
        return (
          <HireStep4
            ...
            inputNot={true}
            head={
              "How often do you require house management or housekeeping services?"
            }
            data={step2Data}
          />
        );
      ...
      case 5:
        return (
          <HireStep4
            ...
            formRef={jobFormRef || {}}
            inputNot={true}
            head={"Do you require cooking services? If so, for whom?"}
            data={step4Data}
          />
        );
      case 6:
      ...
      case 9:
        return (
          <div>
            ...
            >
              <div>
                <p className="mt-10 mb-6 onhdin-head">
                  Do you have any special requirements or{" "}
                  <br className="max-lg:hidden" />
                  preferences for the House Manager?
                </p>
                <Form.Item
