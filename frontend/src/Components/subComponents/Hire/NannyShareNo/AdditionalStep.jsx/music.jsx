...
export default function Music() {
  ...
  const Register = async () => {
    ...
    if (textAreaValue && textAreaValue.length > 0) {
      ...
      updatedAddInfo.push({ key: "musicInstructor", value: formData });
    }
  ...
  const handleNext = async () => {
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, instrumentDoYouLearn: cleanData });
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, currentSkill: values });
            hireStepFormRef.current.resetFields();
            setStep((prevStep) => prevStep + 1); // Move to the next step
          } else {
            // Show an error message if no option is selected
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, requireMusicLessons: values });
            hireStepFormRef.current.resetFields();
            setStep((prevStep) => prevStep + 1); // Move to the next step
          } else {
            // Show an error message if no option is selected
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, eachLessons: values });
            hireStepFormRef.current.resetFields();
            setStep((prevStep) => prevStep + 1); // Move to the next step
          } else {
            // Show an error message if no option is selected
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, prefferLessons: values });
            hireStepFormRef.current.resetFields();
            setStep((prevStep) => prevStep + 1); // Move to the next step
          } else {
            // Show an error message if no option is selected
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, specificGoals: values });
            hireStepFormRef.current.resetFields();
            setStep((prevStep) => prevStep + 1); // Move to the next step
          } else {
            // Show an error message if no option is selected
      ...
      hireStepFormRef.current
        ...
        .then((values) => {
          if (values.option?.length > 0) {
            ...
            setFormData({ ...formData, instructorTeachingStyle: values });
            hireStepFormRef.current.resetFields();
            setStep((prevStep) => prevStep + 1); // Move to the next step
          } else {
            // Show an error message if no option is selected
    ...
    if (step == 9) {
      // Check if special requirements exist
      const hasSpecialReq = trueValuesAfterSpecialized.length > 0;

      // Determine navigati// console.log(val)on based on conditions
      if (textAreaValue && textAreaValue.length > 0) {
        dispatch(
        ...
        dispatch(
          addOrUpdateAdditionalInfo({ key: "musicInstructor", value: formData })
        );
      }
      if (hasSpecialReq) {
        if (v.swimInstructor) {
      ...
      case 8:
        return (
          <HireStep3
            ...
            subHead={"What days and times are you available for music lessons?"}
          />
        );
      case 9:
        return (
