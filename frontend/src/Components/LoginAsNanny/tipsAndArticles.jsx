  ...
  return (
    <div>
      <img
        ...
        src={menuIcon}
        alt="menu"
        className="w-6 h-6 lg:hidden block mx-2 hover:opacity-50 ease-out cursor-pointer"
      />
      {/* Ant Design Drawer */}
      <Drawer
        closable={false}
      ...
      <div className="padding-navbar1 Quicksand">
        <div className=" bg-white rounded-xl mb-12">
          ...
          <div className="lg:flex hidden bg-white -mt-8 justify-between items-center h-20 padding-navbar1">
            {navItemsArticles.map((item) => (
              <div
                key={item}
                data-value={item}
