...
// Default share image: opaque white 1200×630 banner (logo mark + "Famlink").
// Generated by scripts/make-imessage-icon.mjs. Square icon-*.png remain for
// apple-touch / PWA / favicon only. Resource articles still pass their own photo.
//
// Bump ?v= when regenerating icons / og-image.
const DEFAULT_OG_IMAGE = `${SITE_ORIGIN}/og-image.png?v=5`;
