/**
 * Approved navigation intents for landing FAM chat.
 * AI must never emit raw URLs — only these intent keys.
 */
export const FAM_NAV_REGISTRY = {
...
export const resolveNavIntent = (intent) => {
  if (!intent || typeof intent !== "string") return null;
  return FAM_NAV_REGISTRY[intent] || null;
};

export const isApprovedNavIntent = (intent) =>
  Boolean(resolveNavIntent(intent));
